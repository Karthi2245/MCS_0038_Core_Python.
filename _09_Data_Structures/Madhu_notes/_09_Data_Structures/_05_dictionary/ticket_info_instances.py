ticket_info = {
    ...
    "workflow": {
        "unit_test_logs": [
            {
                ...
                "test_files": [
                    {
                        "uploaded_date_utc": "2019-07-10T06:31:43.971Z",
                        "file_upload": True,
                ...
                "test_comments": "",
                "test_status": "pass",
                "updated_date": "2019-07-10T06:31:46.684Z"
            }
        ],
        ...
        "fpd_images": [
            {
                "uploaded_date_utc": "2019-07-10T06:30:52.613Z",
    ...
    "uploader_name": "Madhu Nettem",
    "release_date": "2019-07-10T00:00:00.000Z",
    "new_ver": False,
    "offset_changed": False,
    "default_accessible_to": [
        "madhun"
    ],
    "created_date": "2019-07-10T06:30:31.028Z",
    "fpd_type": "HW",
    "epe": [
        "madhun"
    ],
...
# 1. Get total items in ticket_info dictionary
print("------Total Items-------")
count = 0
...
# Get init_apporver 
        - All records
        - Record whose status is Unit Testing
        - Count stages and display only stages  
# Get fpd_hierarchy assembly_name

'''
print("Workflow......", ticket_info["workflow"] )
print("unittest logs...", ticket_info["workflow"]["unit_test_logs"][0]['testowner'])
print("date", ticket_info["workflow"]["unit_test_logs"][0]["eta"]['value']['date']['day'])